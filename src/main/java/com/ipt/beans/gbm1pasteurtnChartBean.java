...
@Named("gbm1pasteurtnChartBean")
@RequestScoped
public class gbm1pasteurtnChartBean implements Serializable{
    ...
    public void init() {
        ...
        server = serverDAO.getServerInfo("gbm1.pasteur.tn");
        createPieModel();
    ...
    private void createHorizontalBarModel() {
        ...
        hardDiskList = hardDiskDAO.getHardDiskList("gbm1.pasteur.tn");
